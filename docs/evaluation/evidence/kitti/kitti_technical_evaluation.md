...
The frozen contract report is **valid**. It accounts for 1089 valid events: 711 represented, 378 intentionally suppressed, 0 eligible but missed, and 0 explicitly excluded.
...
All 711 of 711 cues were fully traceable under contract 0.1.0. Supplemental mapping-rule, schedule and WAV link checks are reported separately and do not extend the frozen contract.
