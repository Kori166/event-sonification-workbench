...
| 3. Technical Evaluation | Evaluate retained outputs using the technical contract | Synthetic oracle, two real-data reports, repeat comparisons, audited tables and figures, claim-to-evidence mapping and [Stage 3 checklist](stage-3-checklist.md) | Complete, 6 August 2026 |
