...
Last reviewed: 7 August 2026, during Stage 4 Milestone 1 Phase 1.
...
Stage 4 adds R18-R20. R18 and R19 are reduced by the frozen session contract, reuse of existing
package verification and the passing Phase 1 CI tests. R20 remains open because the browser layer
has not yet been implemented or demonstrated; the interface must continue to be described as
research infrastructure rather than participant evidence.
